                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="" method="POST">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="nama_petugas" class="form-control" placeholder="Masukan Nama Lengkap" required autofocus>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label class="col-md-4">Username</label>
                                            <div class="col-md-8">
                                                <input type="text" name="username" class="form-control" placeholder="Masukan Usernames" required>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="btnTambahPetugas" class="btn btn-primary">Tambah Data</button>
                                </div>
                                </form>
